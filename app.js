...
// function yesNoGame(){
//   var questionArray =
//   ['Is Sung originally from Washington?',
//   'Does Sung have any pets?',
//   'Do you think Sung likes to play sports, ' + userName + '?',
//   'Does Sung have any siblings?',
//   'Is Sung Japanese?'];
//   var answerArray = ['NO', 'YES', 'YES', 'YES', 'NO'];
//   var responseArray =
//   ['That\'s right! Sung was originally from Guam',
//   'You got it! Sung has a Japanese chin and Tibetan spaniel mix living with him. His name is Cookie',
//   'Yup! His favorite sports are surfing and rock climbing.',
//   'That\'s right ' + userName + '! Sung has 2 siblings, an older brother and sister.',
//   'I\'m impressed! Sung gets mistaken for Japanese, but is actually Korean!'];
//   var wrongArray =
//   ['Sorry, Sung is actually originally from Guam.',
//   'Sorry, Sung does have one dog named Cookie living with him.',
//   'Even though he spends a lot of time at home, Sung does like to surf and rock climb on occasion!',
//   'Sadly he has to contend with 2 siblings, both older.',
//   'While commonly mistake for being Japanese, Sung is actually Korean.'];
...
//       }
//     } else {
//       alert('You did not enter a Y or N response. You failed this question.');
//     }
//   }
// }
//
